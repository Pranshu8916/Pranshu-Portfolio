...
const Hero = () => {
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20">
      ...
      <div className="absolute top-1/4 left-1/4 w-72 h-72 bg-emerald-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob"></div>
      <div className="absolute top-1/3 right-1/4 w-72 h-72 bg-teal-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000"></div>
      ...
      <div className="container mx-auto px-6 z-10 text-center">
        ...
        >
          <h2 className="text-xl md:text-2xl text-emerald-400 font-semibold mb-4 tracking-wider">HELLO, WORLD!</h2>
          <h1 className="text-5xl md:text-7xl font-extrabold text-white mb-6">
            I'm <span className="bg-clip-text text-transparent bg-gradient-to-r from-emerald-400 to-teal-500">Pranshu Bodara</span>
          </h1>
          ...
          >
            <a href="#projects" className="bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-bold py-3 px-8 rounded-full shadow-lg shadow-emerald-500/30 transition-all hover:scale-105 inline-block w-full sm:w-auto">
              View My Work
            </a>
            <a href="/resume.jpg" download="Pranshu_Bodara_CV.jpg" className="bg-transparent border-2 border-teal-500 hover:bg-teal-500/20 text-white font-bold py-3 px-8 rounded-full shadow-lg shadow-teal-500/10 transition-all hover:scale-105 inline-block w-full sm:w-auto">
              Download Resume
            </a>
          </motion.div>
        </motion.div>
